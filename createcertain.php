...
<div class="container mt-5">
	<form class="needs-validation was-validated" action="finishcertain.php" method="post" novalidate="" >
          <div class="mb-3">
	            <label for="lastName">Ваше ім'я</label>
        ...
        <div class="mb-3">
          <label for="city">Напишіть ваше місто</label>
          <input type="text" class="form-control" id="city" name="city" required="">
          <div class="invalid-feedback">
            Ви не написали назву свого міста.
          </div>
        </div>
